...
export default function OrganizingCommittee() {
  return (
    <section id="committee" className="section-dark pt-8 pb-20 bg-gradient-to-br from-dark-bg via-primary/10 to-secondary/10 dark:bg-dark-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Second row: Lipsa, Kishora, and Binaya in 3-column grid */}
